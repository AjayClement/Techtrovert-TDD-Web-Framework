...
public final class OxdAutoCompleteWrapperComponent extends BaseComponent{
	...
	private static final String OPTION_TEXT_VALUE_LOCATOR = "//span[normalize-space(text())='%s']";
	...
	public WebElement getAutoCompletedOption(String text) {
		return UiWaitHandler.waitUntilElementVisible(
				UiWaitHandler.waitUntilElementVisible(
						parentElement.findElement(
								autoCompleteDropDownLocator), true)
				.findElement(By.xpath(
						String.format(OPTION_TEXT_VALUE_LOCATOR, text))
						),true);
	}

	public List<WebElement> getAutoCompletedOptions(String text) {
		return UiWaitHandler.waitUntilElementsVisible(
				UiWaitHandler.waitUntilElementVisible(
						parentElement.findElement(
								autoCompleteDropDownLocator), true)
				.findElement(By.xpath(
